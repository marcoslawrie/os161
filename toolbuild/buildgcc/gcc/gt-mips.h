...
{
  struct mips16_local_alias * const x = (struct mips16_local_alias *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18mips16_local_alias))
    {
...
{
  struct mflip_mips16_entry * const x = (struct mflip_mips16_entry *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18mflip_mips16_entry))
    {
      gt_pch_n_S ((*x).name);
    }
}
...
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P18mips16_local_alias4htab))
    {
      {
        size_t l0 = (size_t)(((*x)).size);
        if ((*x).entries != NULL) {
          ...
          gt_pch_note_object ((*x).entries, x, gt_pch_p_P18mips16_local_alias4htab);
        }
      }
    }
}
...
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P18mflip_mips16_entry4htab))
    {
      {
        size_t l0 = (size_t)(((*x)).size);
        if ((*x).entries != NULL) {
          ...
          gt_pch_note_object ((*x).entries, x, gt_pch_p_P18mflip_mips16_entry4htab);
        }
      }
    }
}
...
{
  struct mips16_local_alias * x ATTRIBUTE_UNUSED = (struct mips16_local_alias *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).func), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).local), cookie);
...
gt_pch_p_18mflip_mips16_entry (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct mflip_mips16_entry * x ATTRIBUTE_UNUSED = (struct mflip_mips16_entry *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).name), cookie);
}
