/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-4.8.3+os161-2.1/gcc/config/mips/mips.md'.  */
...
#line 22 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 30 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 38 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 42 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 50 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
#line 54 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(INTVAL (op) + 1 != 0));
}
...
const_0_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 58 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
#line 62 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
const_1_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 67 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 76 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(IN_RANGE (INTVAL (op), 0, 1)));
}

int
const_2_or_3_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (GET_CODE (op) == CONST_INT) && (
#line 80 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 84 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(IN_RANGE (INTVAL (op), 0, 3)));
}

int
qi_mask_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (GET_CODE (op) == CONST_INT) && (
#line 88 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(UINTVAL (op) == 0xff));
}

int
hi_mask_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (GET_CODE (op) == CONST_INT) && (
#line 92 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(UINTVAL (op) == 0xffff));
}

int
si_mask_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (GET_CODE (op) == CONST_INT) && (
#line 96 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(UINTVAL (op) == 0xffffffff));
}

int
and_load_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (qi_mask_operand (op, mode)) || ((hi_mask_operand (op, mode)) || (si_mask_operand (op, mode)));
}

int
low_bitmask_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (
#line 104 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(ISA_HAS_EXT_INS)) && ((GET_CODE (op) == CONST_INT) && (
#line 106 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(low_bitmask_len (mode, INTVAL (op)) > 16)));
}

int
and_reg_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (register_operand (op, mode)) || (((!(
#line 110 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
#line 121 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(TARGET_MIPS16
		    ? M16_REG_P (REGNO (op))
		    : GP_REG_P (REGNO (op))))) && (
...
{
  return ((GET_CODE (op) == REG) && (
#line 127 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(REGNO (op) == LO_REGNUM))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 131 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(MD_REG_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
fcc_reload_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 135 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(ST_REG_P (true_regnum (op)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

int
muldiv_target_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return (
#line 138 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
#line 144 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
...
#line 184 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
...
#line 204 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type symbol_type;
...
int
cprestore_save_slot_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return ((GET_CODE (op) == MEM) && (
#line 264 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(mips_cprestore_address_p (XEXP (op, 0), false)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

int
cprestore_load_slot_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  return ((GET_CODE (op) == MEM) && (
#line 268 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
{
  return (
#line 271 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(CONSTANT_P (op))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 275 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
...
#line 282 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
static inline int
symbolic_operand_with_high_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 290 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
int
symbolic_operand_with_high (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  switch (GET_CODE (op))
    {
    case CONST:
...
#line 298 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type symbol_type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &symbol_type)
...
#line 306 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
#line 314 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
static inline int
tls_reloc_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 322 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
int
tls_reloc_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  switch (GET_CODE (op))
    {
    case CONST:
...
{
  return ((GET_CODE (op) == MEM) && (
#line 333 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
#line 338 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
{
...
#line 336 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(ISA_HAS_MACC))) || ((GET_CODE (op) == MINUS) && (
#line 337 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(ISA_HAS_MSAC)))) && (
...
int
mips_cstore_operator (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
...
#line 365 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
(TARGET_MIPS16))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
small_data_pattern (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 369 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/predicates.md"
...
constraint_satisfied_p (rtx op, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_Yb: return satisfies_constraint_Yb (op);
    case CONSTRAINT_Yh: return satisfies_constraint_Yh (op);
    case CONSTRAINT_Yw: return satisfies_constraint_Yw (op);
    case CONSTRAINT_Yx: return satisfies_constraint_Yx (op);
    case CONSTRAINT_ZR: return satisfies_constraint_ZR (op);
    default: break;
    }
  return false;
}
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 108 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(SMALL_OPERAND (ival));

    case CONSTRAINT_J:
      return 
#line 113 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(ival == 0);

    case CONSTRAINT_K:
      return 
#line 118 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(SMALL_OPERAND_UNSIGNED (ival));

    case CONSTRAINT_L:
      return 
#line 124 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(LUI_OPERAND (ival));

    case CONSTRAINT_M:
      return (!(
#line 130 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(SMALL_OPERAND (ival)))) && ((!(
#line 131 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(SMALL_OPERAND_UNSIGNED (ival)))) && (!(
#line 132 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(LUI_OPERAND (ival)))));

    case CONSTRAINT_N:
      return 
#line 137 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(ival >= -0xffff && ival < 0);

    case CONSTRAINT_O:
      return 
#line 142 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(ival >= -0x4000 && ival < 0x4000);

    case CONSTRAINT_P:
      return 
#line 147 "../../gcc-4.8.3+os161-2.1/gcc/config/mips/constraints.md"
(ival > 0 && ival < 0x10000);
