...
srcdir=/home/os161user/os161/toolbuild/bmake

DEFAULT_SYS_PATH="/home/os161user/os161/tools/share/mk"
...
CC="gcc"
CFLAGS="-g -O2 -I. -I${srcdir} -DHAVE_CONFIG_H  -I/home/os161user/os161/toolbuild/bmake/missing -DNEED_HOST_CDEFS_H -DMAKE_NATIVE ${XDEFS}"

MAKE_VERSION=`sed -n '/^MAKE_VERSION=/s,.*=[^0-9]*,,p' Makefile`

MDEFS="-DMAKE_VERSION=\"$MAKE_VERSION\" \
-DMACHINE=\"linux5\" -DMACHINE_ARCH=\"x86_64\" \
